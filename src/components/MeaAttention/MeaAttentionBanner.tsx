...
export default function MeaAttestationHero() {
  const [typedText, setTypedText] = useState("");
  const [showCursor, setShowCursor] = useState(true);
  const fullText = "Ministry of External Affairs – MEA Attestation";
        ...
        <div className="relative h-full flex items-center justify-center text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6 border border-white/20" data-aos="fade-down">
              ...
              <span className="text-white/90 text-sm font-medium">MEA Attestation Services</span>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-10" data-aos="fade-up" data-aos-delay="200">
              {[
                { icon: Shield, text: "Document Authentication" },
                { icon: Award, text: "MEA Stamping" },
