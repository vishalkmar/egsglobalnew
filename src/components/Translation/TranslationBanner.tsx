...
export default function TranslationBanner() {
  ...
  const fullText = "Certified Translation Services";
        ...
        <div className="relative h-full flex items-center justify-center text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6 border border-white/20" data-aos="fade-down">
              ...
              <span className="text-white/90 text-sm font-medium">Translation Services</span>
            </div>
            ...
            <p className="text-white/80 text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="100">
              EGS Group offers accurate and certified translation services for legal, immigration, 
              academic, and official documents, accepted by embassies, government authorities, 
