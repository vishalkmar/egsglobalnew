    ...
    <section className="bg-slate-50 py-12 md:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-10">
          ...
          <ul className="mt-4 inline-flex flex-col sm:flex-row gap-2 sm:gap-4 items-center justify-center text-sm sm:text-base text-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-7">
          {categories.map((category) => (
            ...
            >
              {/* colored bar + title */}
              <div className="rounded-t-2xl bg-gradient-to-r px-4 py-3 text-center text-white font-semibold text-sm sm:text-base tracking-wide"
