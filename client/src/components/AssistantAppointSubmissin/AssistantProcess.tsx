    ...
    <section className="w-full bg-gradient-to-b from-slate-50 via-white to-slate-50 py-14 px-4 sm:px-6 lg:px-10 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="grid gap-7 lg:grid-cols-3">
          {/* Reusable Card (same style for all 3) */}
          {[
            {
              img: indiaImg,
              alt: "India",
              ...
              body: (
                <>
                  ...
                  <p>
                    ...
                    Ensure Delhi VFS / Embassy is correct for your state of
                    residence.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                  ...
                  <p>
                    ...
                    Ideally 6+ months beyond the travel date with enough blank
                    pages.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                    ...
                    Use a working email and Indian mobile number for OTPs, links
                    and alerts.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                    ...
                    For Schengen/other visas, check if old biometrics are valid or
              ...
              body: (
                <>
                 <p>
                  ...
                  <p>
                    <span className="font-semibold text-white">
                      Embassy / VFS eligibility:
                    </span>{" "}
                    Confirm that the Delhi Embassy / VFS accepts Bangladeshi
                    nationals residing in India (some missions require applying
                    from Bangladesh).
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                    ...
                    Some countries may apply extra checks or longer processing time
                  ...
                  <p>
                    ...
                    Clean, undamaged passport with sufficient blank pages and 6+
                    months validity.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                    ...
                    Nationality, place of birth and past visa details must match
                    the passport and old visa stickers.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                      Past visa issues:
                    </span>{" "}
                    Any refusal, overstay or immigration problem must be declared
                    honestly wherever the form asks.
                  </p>
                </>
              ),
            },
              ...
              body: (
                <>
                  ...
                  <p>
                    ...
                    Check if the respective embassy allows Nepalese nationals to
                    apply from Delhi or requires application from Nepal.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                      Country-specific rules:
                    </span>{" "}
                    Certain destinations may conduct extra verification or take
                    longer processing time for Nepalese nationals.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                      Passport requirements:
                    </span>{" "}
                    Clean, undamaged passport with correct spellings, at least 6
                    months validity and enough blank pages.
                  </p>
                  <p>
                    <span className="font-semibold text-white">
                      Past travel / refusals:
                    </span>{" "}
                    Any previous refusal, overstay or immigration issue must be
                    declared truthfully wherever requested in the form.
                  </p>
                </>
              ),
            },
