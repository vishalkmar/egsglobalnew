    ...
    <section className="w-full bg-white py-14 px-4 sm:px-6 lg:px-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-sm sm:text-base text-gray-500 max-w-3xl mx-auto">
        ...
        {/* Main Card */}
        <div className="relative rounded-3xl border border-gray-100 bg-white/90 shadow-sm hover:shadow-lg transition-shadow duration-200 overflow-hidden">
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              centre (such as VFS Global). These services help foreign
              travellers, students, workers, and residents complete all
              formalities required before entering a country or receiving
              official documentation abroad.
            </p>
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] items-start">
              ...
              <div>
                ...
                <ul className="space-y-2.5 text-sm sm:text-base text-gray-700">
                  <li className="flex gap-2">
                    ...
                    <span>
                      Submitting visa applications for tourism, business,
                      study, work, or long-term stay
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-emerald-500" />
              ...
              <div className="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4 sm:p-5">
                ...
                <div className="mt-4 rounded-xl bg-white/80 border border-emerald-100 px-3 py-2.5 text-xs sm:text-sm text-emerald-950">
